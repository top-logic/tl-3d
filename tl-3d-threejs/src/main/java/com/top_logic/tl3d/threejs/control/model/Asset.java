...
public abstract class Asset extends de.haumacher.msgbuf.graph.AbstractSharedGraphNode {
	...
	public enum TypeKind {
		...
		/** Type literal for {@link com.top_logic.tl3d.threejs.control.model.Model3D}. */
		MODEL_3_D,
	...
	public interface Visitor<R,A,E extends Throwable> {
		...
		/** Visit case for {@link com.top_logic.tl3d.threejs.control.model.Model3D}.*/
		R visit(com.top_logic.tl3d.threejs.control.model.Model3D self, A arg) throws E;
	...
	public static com.top_logic.tl3d.threejs.control.model.Asset readAsset(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in) throws java.io.IOException {
		...
		int id = in.nextInt();
		switch (type) {
			case Model3D.MODEL_3_D__TYPE: result = com.top_logic.tl3d.threejs.control.model.Model3D.create(); break;
