...
public class Cube extends Asset {
	...
	/**
	 * Creates a {@link com.top_logic.tl3d.threejs.control.model.Cube} instance.
	 */
	public static com.top_logic.tl3d.threejs.control.model.Cube create() {
		return new com.top_logic.tl3d.threejs.control.model.Cube();
	}

	/** Identifier for the {@link com.top_logic.tl3d.threejs.control.model.Cube} type in JSON format. */
	 ...
	 *
	 * @see com.top_logic.tl3d.threejs.control.model.Cube#create()
	 */
	protected Cube() {
		super();
	}
	 ...
	 * @see #getWidth()
	 */
	public com.top_logic.tl3d.threejs.control.model.Cube setWidth(float value) {
	 ...
	 * @see #getHeight()
	 */
	public com.top_logic.tl3d.threejs.control.model.Cube setHeight(float value) {
	 ...
	 * @see #getDepth()
	 */
	public com.top_logic.tl3d.threejs.control.model.Cube setDepth(float value) {
	...
	public static com.top_logic.tl3d.threejs.control.model.Cube readCube(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in) throws java.io.IOException {
		if (in.peek() == de.haumacher.msgbuf.json.JsonToken.NUMBER) {
			return (com.top_logic.tl3d.threejs.control.model.Cube) scope.resolveOrFail(in.nextInt());
		}
		in.beginArray();
		String type = in.nextString();
		assert CUBE__TYPE.equals(type);
		int id = in.nextInt();
		com.top_logic.tl3d.threejs.control.model.Cube result = new com.top_logic.tl3d.threejs.control.model.Cube();
