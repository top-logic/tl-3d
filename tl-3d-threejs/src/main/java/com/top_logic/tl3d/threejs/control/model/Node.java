...
public abstract class Node extends de.haumacher.msgbuf.graph.AbstractSharedGraphNode {

	/** Type codes for the {@link com.top_logic.tl3d.threejs.control.model.Node} hierarchy. */
	public enum TypeKind {

		/** Type literal for {@link com.top_logic.tl3d.threejs.control.model.Group}. */
		GROUP,

		/** Type literal for {@link com.top_logic.tl3d.threejs.control.model.Part}. */
		PART,
		;

	}

	/** Visitor interface for the {@link com.top_logic.tl3d.threejs.control.model.Node} hierarchy.*/
	public interface Visitor<R,A,E extends Throwable> {

		/** Visit case for {@link com.top_logic.tl3d.threejs.control.model.Group}.*/
		R visit(com.top_logic.tl3d.threejs.control.model.Group self, A arg) throws E;

		/** Visit case for {@link com.top_logic.tl3d.threejs.control.model.Part}.*/
		R visit(com.top_logic.tl3d.threejs.control.model.Part self, A arg) throws E;
	...
	private final java.util.List<Float> _transform = new de.haumacher.msgbuf.util.ReferenceList<>() {
		...
		protected void beforeAdd(int index, Float element) {
			_listener.beforeAdd(Node.this, TRANSFORM__PROP, index, element);
		}

		@Override
		protected void afterRemove(int index, Float element) {
			_listener.afterRemove(Node.this, TRANSFORM__PROP, index, element);
		}
	};
	 ...
	 * @see #getTransform()
	 */
	public com.top_logic.tl3d.threejs.control.model.Node setTransform(java.util.List<? extends Float> value) {
	 ...
	 */
	public com.top_logic.tl3d.threejs.control.model.Node addTransform(float value) {
	...
	public static com.top_logic.tl3d.threejs.control.model.Node readNode(de.haumacher.msgbuf.graph.Scope scope, de.haumacher.msgbuf.json.JsonReader in) throws java.io.IOException {
		if (in.peek() == de.haumacher.msgbuf.json.JsonToken.NUMBER) {
			return (com.top_logic.tl3d.threejs.control.model.Node) scope.resolveOrFail(in.nextInt());
		}
		com.top_logic.tl3d.threejs.control.model.Node result;
		in.beginArray();
		String type = in.nextString();
		int id = in.nextInt();
		switch (type) {
			case Group.GROUP__TYPE: result = com.top_logic.tl3d.threejs.control.model.Group.create(); break;
			case Part.PART__TYPE: result = com.top_logic.tl3d.threejs.control.model.Part.create(); break;
