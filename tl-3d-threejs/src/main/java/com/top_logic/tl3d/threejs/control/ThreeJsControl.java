...
import com.top_logic.tl3d.threejs.control.model.Group;
import com.top_logic.tl3d.threejs.control.model.Model3D;
import com.top_logic.tl3d.threejs.control.model.Part;
import com.top_logic.tl3d.threejs.control.model.Scene;
...
public class ThreeJsControl extends AbstractControlBase implements ContentHandler {
	...
	public ThreeJsControl() {
		Model3D werker = Model3D.create().setUrl("/assets/Library/Werker/Werker_sitzend.glb");
		_model = Scene.create()
			.setRoot(Group.create()
				.addContent(Part.create()
					.setAsset(Model3D.create().setUrl("/assets/Library/F1/KR_300_R2500_ultra/KR300R2500ultra_.glb"))
