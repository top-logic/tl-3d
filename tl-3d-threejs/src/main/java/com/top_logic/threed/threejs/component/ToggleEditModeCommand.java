 ...
 */
public class ToggleEditModeCommand extends ToggleCommandHandler {

	/**
	 * Configuration of {@link ToggleEditModeCommand}.
	 */
	public interface Config extends ToggleCommandHandler.Config {
		@Override
		@ClassDefault(ToggleEditModeCommand.class)
	...
	/**
	 * Creates a {@link ToggleEditModeCommand}.
	 */
	public ToggleEditModeCommand(InstantiationContext context, Config config) {
