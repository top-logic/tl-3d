...
public class ToggleTranslateAxes extends ToggleCommandHandler {
	@DisplayOrder({
	...
	public interface Config extends ToggleCommandHandler.Config {
		@Override
		@ClassDefault(ToggleTranslateAxes.class)
	...
	/**
	 * Creates a {@link ToggleTranslateAxes}.
	 */
	public ToggleTranslateAxes(InstantiationContext context, Config config) {
