...
public class GizmoControl extends AbstractControl {
	...
	private FormField newRotateStepSizeField() {
		FormField rotateStepSize = newStepSizeField(ROTATE_STEP_SIZE, I18NConstants.ROTATE_STEP_SIZE_LABEL);
	...
	private FormField newTranslateStepSizeField() {
		FormField translateStepSize = newStepSizeField(TRANSLATE_STEP_SIZE, I18NConstants.TRANSLATE_STEP_SIZE_LABEL);
	...
	/**
	 * Writes the field displaying the rotation step size.
	 */
	...
	/**
	 * Label of the field displaying the rotation step size.
	 */
